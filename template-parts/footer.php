...
<footer class="footer_wrapper py-20">
	<div class="custom_container_lg">
		<div class="flex justify-between footer_top">
			...
			<form action="" method="get" class="search_form search_form_2">
				<input type="text" name="search_val" placeholder="Enter your E-mail">
				<button type="submit" name="search_btn">Subscribe</button>
			</form>
		</div>

		<div class="flex justify-between items-end footer_bottom">
			<div class="order_2_mob">
				<ul class="footer_menu">
					<li><a href="#!">Home</a></li>
					<li><a href="#!">Contact</a></li>
					<li><a href="#!">Terms and Conditions</a></li>
					<li><a href="#!">Advertiser Policy</a></li>
				</ul>
				<p class="text_4">Get in touch: <a href="mailto:youremail@gmail .com">youremail@gmail .com</a></p>
			</div>

			<div class="order_1_mob">
				<ul class="social social_2">
				...
				<p class="text-white text_3 mt-4">Medicine Unlocked is your gateway to a treasure trove of medical insights information and knowledge Whether you a medical.</p>
			</div>
		</div>
	</div>
</footer>